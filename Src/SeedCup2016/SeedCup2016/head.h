...
extern inline void Push_Scope(char *scope_name);//作用域入栈
extern inline void Pop_Scope(void);//作用域出栈
extern void Push_Var(char *var_name, int var_value);//保存新变量
extern int Get_Var(char *var_name);//获取变量值
extern void Set_Var(char *var_name, int var_value);//改变变量值
